...
// if (starttime ==1 && endtime ==2) --> 0.5
// if(starttime ==2 && endtime ==3) -->0.5
// if(starttime ==1 && endtime ==3) -->1
              ...
              >
                <Grid item xs={12} sm={4} md={4} lg={4}>
                  <Autocomplete
                    ...
                    fullWidth
                    value={values.find(
                      (option) => option.id === formik.values.Leave
                    ) || null}
                    onChange={(e, value) => {
                      if (value === null) {
                        ...
                        formik.setFieldValue("Leave", value.id)
                    }}
              ...
              <p></p>
                ...
                <Grid item xs={12} sm={4} md={4} lg={4}>
                  <Autocomplete
                    ...
                    fullWidth
                    value={values1.find(
                      (option) => option.id === formik.values.StationLeave
                    ) || null}
                    onChange={(e, value) => {
                      if (value === null) {
                        ...
                        formik.setFieldValue("StationLeave", value.id)
                    }}
                    getOptionLabel={(value) => value.label}
                    renderInput={(params) => (
                      <TextField {...params}
